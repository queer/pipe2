...
public class HelperGenerator implements Generator {
    public byte[] generate() {
        ...
        final MappedClass minecraft = ClassMap.getClassByName("Minecraft");
        final MappedClass fontRenderer = ClassMap.getClassByName("FontRenderer");
        final MappedClass world = ClassMap.getClassByName("World");
        final MappedClass entityClientPlayer = ClassMap.getClassByName("EntityClientPlayer");
        final MappedClass gameSettings = ClassMap.getClassByName("GameSettings");
        final MappedClass abstractWorld = ClassMap.getClassByName("AbstractWorld");
        final MappedClass entity = ClassMap.getClassByName("Entity");
        final MappedClass worldProvider = ClassMap.getClassByName("WorldProvider");
        final MappedClass entityLiving = ClassMap.getClassByName("EntityLiving");
        final MappedClass entityAnimal = ClassMap.getClassByName("EntityAnimal");
        final MappedClass entityMonster = ClassMap.getClassByName("EntityMonster");
        final MappedClass entityPlayer = ClassMap.getClassByName("EntityPlayer");
        final MappedClass blockEntity = ClassMap.getClassByName("BlockEntity");
        final MappedClass blockPos = ClassMap.getClassByName("BlockPos");
        final MappedClass vec3i = ClassMap.getClassByName("Vec3i");
        final MappedClass blockEntityChest = ClassMap.getClassByName("BlockEntityChest");
        final MappedClass blockEntityEnderChest = ClassMap.getClassByName("BlockEntityEnderChest");
        final MappedClass entityRenderer = ClassMap.getClassByName("EntityRenderer");
        final MappedClass chatComponentText = ClassMap.getClassByName("ChatComponentText");
        final MappedClass ichatComponent = ClassMap.getClassByName("IChatComponent");
        final MappedClass packet = ClassMap.getClassByName("Packet");
        final MappedClass netClientPlayHandler = ClassMap.getClassByName("NetClientPlayHandler");
        final MappedClass guiScreen = ClassMap.getClassByName("GuiScreen");
        final MappedClass scaledResolution = ClassMap.getClassByName("ScaledResolution");
        final MappedClass packetClientChatMessage = ClassMap.getClassByName("PacketClientChatMessage");
        final MappedClass packetClientTabComplete = ClassMap.getClassByName("PacketClientTabComplete");
        final MappedClass container = ClassMap.getClassByName("Container");
        final MappedClass itemStack = ClassMap.getClassByName("ItemStack");
        final MappedClass inventoryPlayer = ClassMap.getClassByName("InventoryPlayer");
